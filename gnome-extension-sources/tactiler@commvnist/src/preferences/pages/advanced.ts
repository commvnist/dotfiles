...
function createTileAppearanceGroup(settings: Gio.Settings): Adw.PreferencesGroup {
...
function createGridSizeGroup(settings: Gio.Settings): Adw.PreferencesGroup {
    const group = new Adw.PreferencesGroup({
        title: "Grid Size",
    });
...
function createBehaviorGroup(settings: Gio.Settings): Adw.PreferencesGroup {
    const group = new Adw.PreferencesGroup({
        title: "Behavior",
    });
...
function createColorRow(settings: Gio.Settings, id: string, title: string): Adw.ActionRow {
...
function createSwitchRow(settings: Gio.Settings, id: string, title: string): Adw.SwitchRow {
